...
chmod 755 ./etc
${do_chown} && chown root:root ./etc/dnsmasq.d
chmod 755 ./etc/dnsmasq.d
${do_chown} && chown root:root ./etc/dnsmasq.d/dns-cache.conf
chmod 644 ./etc/dnsmasq.d/dns-cache.conf
${do_chown} && chown root:root ./etc/dnsmasq.d/pxe.conf
chmod 644 ./etc/dnsmasq.d/pxe.conf
${do_chown} && chown root:root ./etc/dnsmasq.d/security.conf
chmod 644 ./etc/dnsmasq.d/security.conf
