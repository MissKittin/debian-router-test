...
mount -t overlay -o ${OVERLAYFS_MOUNT_OPTIONS}lowerdir=/,upperdir=${DESTINATION}/${CONTAINER_ROOT}/diff,workdir=${DESTINATION}/${CONTAINER_ROOT}/tmp "${MOUNT_LABEL}" "${DESTINATION}/${CONTAINER_ROOT}/mnt"
