...
# Comments: first column: daemon_enabled deprecated, second column: settings reloading deprecated
...
#					;;
	...
	#					[ -e /tmp/.acpid-autosuspend-reload_settings ] || touch /tmp/.acpid-autosuspend-reload_settings
			...
			;;
			'lock')
				[ -e '/var/run/.acpid-autosuspend.templock' ] || echo -n '' > '/var/run/.acpid-autosuspend.templock'
			;;
			'unlock')
				[ -e '/var/run/.acpid-autosuspend.templock' ] && rm '/var/run/.acpid-autosuspend.templock'
			;;
		esac
	;;
esac 
