...
${do_chown} && chown root:root ./share/bootstrap-installer/pre-chroot.d/S01_check-internet.rc
chmod 644 ./share/bootstrap-installer/pre-chroot.d/S01_check-internet.rc
...
${do_chown} && chown root:root ./share/bootstrap-installer/pre-chroot.d/S01_root-partition.rc
chmod 644 ./share/bootstrap-installer/pre-chroot.d/S01_root-partition.rc
...
${do_chown} && chown root:root ./share/bootstrap-installer/in-chroot.d/K99_dump-settings.rc
chmod 644 ./share/bootstrap-installer/in-chroot.d/K99_dump-settings.rc
${do_chown} && chown root:root ./share/bootstrap-installer/in-chroot.d/S50_desktop-env-tweaks.rc
chmod 644 ./share/bootstrap-installer/in-chroot.d/S50_desktop-env-tweaks.rc
...
${do_chown} && chown root:root ./share/bootstrap-installer/in-chroot.d/S50_auto-login.rc
chmod 644 ./share/bootstrap-installer/in-chroot.d/S50_auto-login.rc
...
${do_chown} && chown root:root ./share/bootstrap-installer/in-chroot.d/S26_apt-purge.rc
chmod 644 ./share/bootstrap-installer/in-chroot.d/S26_apt-purge.rc
${do_chown} && chown root:root ./share/bootstrap-installer/in-chroot.d/K10_fake-libpam-systemd.rc
chmod 644 ./share/bootstrap-installer/in-chroot.d/K10_fake-libpam-systemd.rc
