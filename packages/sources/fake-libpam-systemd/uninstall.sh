...
echo -n '[rm] /usr/local/etc/apt/sources.list.d/fake-libpam-systemd.list'
	rm /usr/local/etc/apt/sources.list.d/fake-libpam-systemd.list > /dev/null 2>&1 && echo ' [OK]' || echo ' [Fail]'

# Uninstall - /usr/local/share
echo -n '[rm] /usr/local/share/fake-libpam-systemd'
	rm /usr/local/share/fake-libpam-systemd > /dev/null 2>&1 && echo ' [OK]' || echo ' [Fail]'


# Uninstall - /etc/apt
echo -n '[rm] /etc/apt/sources.list.d/fake-libpam-systemd.list'
	rm /etc/apt/sources.list.d/fake-libpam-systemd.list > /dev/null 2>&1 && echo ' [OK]' || echo ' [Fail]'
