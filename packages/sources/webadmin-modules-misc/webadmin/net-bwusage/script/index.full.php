...
window.addEventListener('DOMContentLoaded', function(){
	...
	function getInterfacesData(interfaces, info)
	{
		...
		getJSON(dataProvider + '/api?queryInterfaces&interfaces=' + interfacesToQuery, 'get', function(err, response){
			if(err == null)
			{
	...
	function getInterfacesInfo(interfaces)
	{
		...
		getJSON(dataProvider + '/api?getInterfacesInfo&interfaces=' + interfacesToQuery, 'get', function(err, response){
	...
	getJSON(dataProvider + '/api?getInterfaces', 'get', function(err, response){
